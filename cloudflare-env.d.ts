/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: f5d14f8106b624d8c9410092507e0398)
...
interface __BaseEnv_CloudflareEnv {
	...
	CHAT_ROOM_DO: DurableObjectNamespace<import("./worker").ChatRoomDO>;
	WORKER_SELF_REFERENCE: Service<typeof import("./worker").default>;
	WORKFLOWS: Workflow<Parameters<import("./worker").PorhaiWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "DATABASE_URL" | "NEXT_PUBLIC_APP_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "RESEND_API_KEY" | "EMAIL_FROM" | "B2_ENDPOINT" | "B2_KEY_ID" | "B2_APP_KEY" | "B2_BUCKET_NAME">> {}
}
